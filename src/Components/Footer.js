  ...
  return (
    <footer>
      <div className="social">
        <img src={fbicon} alt="" className="social__icons" width="40"/>
        <img src={igicon} alt="" className="social__icons" width="40"/>
        <img src={twicon} alt="" className="social__icons" width="40"/>
      </div>
